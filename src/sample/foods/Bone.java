...
public class Bone extends Food {
    ...
    protected Image image = new Image(getClass().getResourceAsStream("../resources/sprites/bone.png"), count*width, height, false, true);
    protected ImageView imageView = new ImageView(image);

    public Bone(Pet pet, PetController petController) {
